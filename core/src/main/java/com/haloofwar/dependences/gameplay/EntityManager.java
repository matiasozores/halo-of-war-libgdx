...
public class EntityManager {
	...
	private final ArrayList<Renderable> entities = new ArrayList<>();
	...
	public void render(SpriteBatch batch) {
		for (Renderable entity : this.entities) {
			entity.render(batch);
		}
	}

	public void clear() {
		System.out.println("Eliminando todas las entidades y actualizables del EntityManager");
		this.entities.clear();
