...
public class AssaultRifle extends Gun{
	public AssaultRifle(InputManager input, BulletManager bullet, TextureManager texture, CollisionManager collision, SoundManager sound) {
		super("Rifle de Asalto", 10, 50, 20, input, bullet, texture, collision, sound);
	}
}
