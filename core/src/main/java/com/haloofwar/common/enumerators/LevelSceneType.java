...
public enum LevelSceneType implements SceneDescriptor, SceneKey {
    ...
    TUTORIAL("cave", SceneType.CAVE, 1, 5, 1, 5, CutSceneDataType.INTRO, new EnemyType[] {EnemyType.ELITE_INOFENSIVO}, 50),
    LEVEL_ONE_ONE("Level 1_1", SceneType.THE_LOAST_COAST, 1, 1, 1, 1, new EnemyType[] {EnemyType.ELITE}, 300),
    LEVEL_ONE_TWO("Level 1_2", SceneType.ENTRANCE_TO_TARTARUS, 1, 1, 1, 1, new EnemyType[] {EnemyType.ELITE}, 350),
    LEVEL_ONE_THREE("Level 1_3", SceneType.SUBMERGED_TEMPLE, 1, 1, 1, 1, new EnemyType[] {EnemyType.ELITE}, 400),
    INFINITY("infinity", SceneType.CAVE, 1, 2, Integer.MAX_VALUE, Integer.MAX_VALUE, new EnemyType[] {EnemyType.ELITE}, 99999);

	static {
		TUTORIAL.nextLevel = LEVEL_ONE_ONE;
		LEVEL_ONE_ONE.nextLevel = LEVEL_ONE_TWO;
		LEVEL_ONE_TWO.nextLevel = LEVEL_ONE_THREE;
		LEVEL_ONE_THREE.nextLevel = INFINITY;
	}
