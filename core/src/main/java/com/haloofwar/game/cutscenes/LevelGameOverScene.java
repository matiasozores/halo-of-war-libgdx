...
public class LevelGameOverScene implements Scene {

    private SpriteBatch batch;
    private Texture levelGameOverTexture;
    ...
    public LevelGameOverScene(GameStaticCamera camera, SpriteBatch batch, Texture levelGameOverTexture, EventBus bus, SceneType type) {
        this.batch = batch;
        this.levelGameOverTexture = levelGameOverTexture;
        this.bus = bus;
        this.type = type;
        this.camera = camera;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        batch.draw(this.levelGameOverTexture, 0, 0, this.camera.getViewportWidth(), this.camera.getViewportHeight());
        batch.end();
    }
