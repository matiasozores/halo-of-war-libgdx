...
public final class ObjectFactory {
    ...
    public static Entity createItemByName(final String NAME, final TextureManager TEXTURE) {
    ...
    public static Entity createItem(final Rectangle RECTANGLE, final ObjectType TYPE, final TextureManager TEXTURE) {
    	...
    	ENTITY.addComponent(ComponentPresets.defaultTransform(RandomUtils.generateUniqueId(), RECTANGLE.x, RECTANGLE.y, WIDTH, HEIGHT));
